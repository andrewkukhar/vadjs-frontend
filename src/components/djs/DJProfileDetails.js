  ...
  return (
    ...
    >
      ...
      <Typography variant="body1" gutterBottom>
        {dj.fullBio && dj.fullBio.length > 150 ? dj.fullBio.substring(0, 147) + "..." : dj.fullBio}
      </Typography>
      ...
      <List>
        {dj.socialMediaLinks && Object.keys(dj.socialMediaLinks).length > 0 ? (
          Object.entries(dj.socialMediaLinks).map(([platform, url]) => (
            ...
            <Typography variant="body2">No social media links available.</Typography>
          )}
      </List>
    </Box>
  );
