...
export default function LinksEvents({
  isEditMode,
  localData,
  handleInputChange,
        ...
        {isEditMode ? (
          ...
          <div>
            {localData?.socialMediaLinks?.instagram ? (
              <Link
                href={localData?.socialMediaLinks?.instagram}
                target="_blank"
        ...
        {isEditMode ? (
          ...
          <div>
            {localData?.socialMediaLinks?.facebook ? (
              <Link
                href={localData?.socialMediaLinks?.facebook}
                target="_blank"
                rel="noopener noreferrer"
                variant="body1"
              >
      ...
      <Grid item xs={12} sx={{ p: "1rem" }}>
        ...
        {isEditMode ? (
          <Input
            ...
            onChange={(e) =>
              handleInputChange("socialMediaLinks.soundcloud", e.target.value)
            }
          />
        ) : (
          <div>
            {localData?.socialMediaLinks?.soundcloud ? (
              <Link
                href={localData?.socialMediaLinks?.soundcloud}
                target="_blank"
                rel="noopener noreferrer"
                variant="body1"
              >
        ...
        {isEditMode ? (
          ...
          <div>
            {localData?.socialMediaLinks?.youtube ? (
              <Link
                href={localData?.socialMediaLinks?.youtube}
                target="_blank"
                rel="noopener noreferrer"
                variant="body1"
              >
      ...
      <Grid item xs={12} sx={{ p: "1rem" }}>
        ...
        {isEditMode ? (
          <Input
            ...
            onChange={(e) =>
              handleInputChange("socialMediaLinks.beatport", e.target.value)
            }
          />
        ) : (
          <div>
            {localData?.socialMediaLinks?.beatport ? (
              <Link
                href={localData?.socialMediaLinks?.beatport}
                target="_blank"
                rel="noopener noreferrer"
                variant="body1"
              >
      ...
      <Grid item xs={12} sx={{ p: "1rem" }}>
        ...
        {isEditMode ? (
          <Input
            ...
            onChange={(e) =>
              handleInputChange("socialMediaLinks.mixcloud", e.target.value)
            }
          />
        ) : (
          <div>
            {localData?.socialMediaLinks?.mixcloud ? (
              <Link
                href={localData?.socialMediaLinks?.mixcloud}
                target="_blank"
                rel="noopener noreferrer"
                variant="body1"
              >
      ...
      <Grid item xs={12} sx={{ p: "1rem" }}>
        ...
        {isEditMode ? (
          <TextField
            ...
            onChange={(e) =>
              handleInputChange("upcomingEvents.0.name", e.target.value)
            }
          />
        ) : (
